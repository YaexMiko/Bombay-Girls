...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002169716580"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7512463676"))

#Port
PORT = os.environ.get("PORT", "1180")

#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Bombay:aloksingh@cluster0.w0ajh.mongodb.net/?retryWrites=true&w=majority")
JOIN_REQS_DB = environ.get("JOIN_REQS_DB", DB_URI)
DB_NAME = os.environ.get("DATABASE_NAME", "Bombay")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002472204739"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002481765296"))
